...
class DatasetPipeline(Generic[T]):
    ...
    def __init__(
        ...
        # Whether the base datasets (from _base_iterable) can be cleared
        # after read. For example, if the base datasets are generated by
        # the other pipeline, they can be safely cleared after read, ensured
    ...
    def iter_batches(
        ...
        *,
        ...
        yield from batch_blocks(
            ...
            clear_block_after_read=self._can_clear_output_blocks_after_read(),
    ...
    def _split(
        ...
        return [
            ...
            DatasetPipeline(
                ...
                self._can_clear_output_blocks_after_read(),
                length=self._length,
                progress_bars=False,
            )
            for idx in range(n)
