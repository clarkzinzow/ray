...
class Dataset(Generic[T]):
    ...
    def split(self,
              ...
              *,
              ...
              locality_hints: Optional[List[Any]] = None) -> List[
                  "Dataset[T]"]:
        ...
        """
        block_lists = split(
            self._blocks, n, equal=equal, blocks_per_split=blocks_per_split,
    ...
    def _split(self, index: int,
        ...
        (left_blocks, left_metadata, right_blocks,
         right_metadata) = _split_blocks(
            self._blocks, self._blocks.get_metadata())
...
def _split_blocks(
        ...
        return_right_half: bool) -> (
            List[Block], List[BlockMetadata], List[Block],
            List[BlockMetadata]):
    get_num_rows = cached_remote_fn(_get_num_rows)
